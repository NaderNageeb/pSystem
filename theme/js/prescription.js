$("#item_search").autocomplete({
    source: function(data, cb){
        $.ajax({
        	autoFocus:true,
            url: $("#base_url").val()+'prescription/get_json_items_details',
            method: 'GET',
            dataType: 'json',
...
function return_row_with_data(item_id){
	...
	$.post(base_url+"prescription/return_row_with_data/"+rowcount+"/"+item_id,{},function(result){
        //alert(result);
...
$('#preview').on("click",function (e) {
  ...
  var this_id=this.id;
        ...
        $.ajax({
        type: 'POST',
        url: base_url+'prescription/preview_labels',
        data: data,
        cache: false,
        contentType: false,
        processData: false,
