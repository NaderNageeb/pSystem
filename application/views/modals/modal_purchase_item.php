                           ...
                           <div class="box box-solid bg-gray">
                              <div class="box-body">
                                 <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                          <label for="item_discount_input"><?= $this->lang->line('price'); ?></label>
                                        <input type="text" class="form-control only_currency" id="popup_item_price" name="item_price_input" placeholder="" >
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                          <label for="item_expire_date"><?= $this->lang->line('expire_date'); ?></label>
                                        <input type="date" class="form-control only_currency" id="popup_item_expire_date" name="item_expire_date_input" placeholder="">
                                        <!-- <span id='popup_item_name'><span> -->
                                        </div>
                                    </div>
