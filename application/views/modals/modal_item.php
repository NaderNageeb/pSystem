...
<?php   $item_code = get_init_code('item');  ?>
                        ...
                        <div class="col-md-4">
                            <div class="box-body">
                              <div class="form-group">
                                <label for="m_item_code"><?= $this->lang->line('item_code'); ?><span class="text-danger">*</span></label>
                                <span id="m_item_code" class="text-danger text-right pull-right"></span>
                                <input type="text" class="form-control" value="<?php print $item_code; ?>" id="m_item_code" name="m_item_code" placeholder="">
                              </div>
                            </div>
                          </div>
                          ...
                          <div class="col-md-4">
                            <div class="box-body">
                              <div class="form-group">
                                <label for="m_expire_date"><?= $this->lang->line('expire_date'); ?></label>
                                <span id="m_expire_date_msg" class="text-danger text-right pull-right"></span>
                                <input type="date" class="form-control" id="m_expire_date" name="m_expire_date" placeholder=""  >
                              </div>
                            </div>
                          </div>
                          ...
                          <div class="col-md-4">
                            <div class="box-body">
                              <div class="form-group">
                                ...
                                <input type="text" class="form-control only_currency" id="m_profit_margin" name="m_profit_margin" placeholder=""  >
                              </div>
                            </div>
                          </div>
