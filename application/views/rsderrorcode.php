      ...
      <div class="row">
        ...
        <div class="col-xs-12">
          <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <div class="box-body">
              <table id="exam" class="table table-bordered custom_hover" width="100%">
                <thead class="bg-gray ">
                <tr>
               
                  <th>#</th>
                  <th>Error Code</th>
                  <th>Arabic Desccription</th>
...
//         "ajax": {
//             "url": "<?php echo site_url('rsdsale/ajax_list')?>",
//             "type": "POST",
//             "data": {
...
$(document).ready(function() {
 ...
 /* dom:'<"row"<"col-sm-12"<"pull-left"B><"pull-right">>> <"row margin-bottom-12"<"col-sm-12"<"pull-left"l><"pull-right"fr>>>tip',*/
      buttons: {
        ...
        // Load data for the table's content from an Ajax source
        "ajax": {
            "url": "<?php echo site_url('rsderrorcode/ajax_list')?>",
            "type": "POST",
