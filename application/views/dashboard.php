        ...
        <div class="row">
          <div class="box-header">
              <div class="btn-group pull-right">
                <button type="button" title="Today" class="btn btn-default btn-info get_tab_records active">يومي</button>
                <button type="button" title="Current Week" class="btn btn-default btn-info get_tab_records">إسبوعي</button>
                <button type="button" title="Current Month" class="btn btn-default btn-info get_tab_records ">شهري</button>
                <button type="button" title="Current Year" class="btn btn-default btn-info get_tab_records">سنوي</button>
                <button type="button" title="All Years" class="btn btn-default btn-info get_tab_records ">الكل</button>
              </div>
          </div><br>
          ...
          <div class="box box-primary" >
            ...
            <div class="box-header ">
              ...
              <div class="btn-group pull-right hide">
                <button type="button" title="Today" class="btn btn-default btn-info get_storewise_details ">اليوم</button>
                <button type="button" title="Current Week" class="btn btn-default btn-info get_storewise_details">اسبوع</button>
                <button type="button" title="Current Month" class="btn btn-default btn-info get_storewise_details ">شهر</button>
                <button type="button" title="Current Year" class="btn btn-default btn-info get_storewise_details">سنة</button>
                <button type="button" title="All Years" class="btn btn-default btn-info get_storewise_details active">كل</button>
              </div>
            </div>
     ...
     <div class="col-md-8 animated">
      ...
      <div class="row">
        ...
        <div class="col-md-12">
          <div class="box box-primary">
            <div class="box-header">
              <h3 class="box-title text-uppercase"><?= $this->lang->line('alert') .'  '.$this->lang->line('expire_date'); ?></h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body table-responsive">
              <table id="exam" class="table table-bordered table-hover">
                ...
                <tr class='bg-warning'>
                  ...
                  <th><?= $this->lang->line('left_days'); ?></th>
                  <th><?= $this->lang->line('stock'); ?></th>
                </tr>
                </thead>
                <tbody>
...
$(document).ready(function() {
 ...
 /* dom:'<"row"<"col-sm-12"<"pull-left"B><"pull-right">>> <"row margin-bottom-12"<"col-sm-12"<"pull-left"l><"pull-right"fr>>>tip',*/
      buttons: {
        ...
        // Load data for the table's content from an Ajax source
        "ajax": {
            "url": "<?php echo site_url('dashboard/expair_date_list')?>",
            "type": "POST",
