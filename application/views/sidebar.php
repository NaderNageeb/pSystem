...
<li class="sales-return-list-active-li "><a href="<?php echo $base_url; ?>prescription"><i class="fa fa-list "></i> <span><?= $this->lang->line('prescription'); ?></span>
...
<?php } ?>
    ...
    <?php if(!is_user()){?>
    <!--<li class="header">CUSTOMERS</li>-->
    <?php if($CI->permissions('rsdusers') || $CI->permissions('rsdsale') || $CI->permissions('rsdsalescancel') || $CI->permissions('rsderrorcode') || $CI->permissions('rsdsaleservice') || $CI->permissions('import_suppliers')) { ?>
    <li class="customers-view-active-li customers-active-li import_customers-active-li suppliers-list-active-li suppliers-active-li import_suppliers-active-li treeview">
          <a href="#">
            <i class="fa fa-group text-aqua"></i> <span><?= $this->lang->line('rsd'); ?></span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
           <ul class="treeview-menu">
        <?php //if($CI->permissions('rsdusers')) { ?>
        <li class="customers-active-li"><a href="<?php echo $base_url; ?>rsdusers"><i class="fa fa-plus-square-o "></i> <span><?= $this->lang->line('rsd_password'); ?></span></a></li>
        <?php //} ?>

        <?php //if($CI->permissions('rsdsale')) { ?>
         <li class="customers-view-active-li"><a href="<?php echo $base_url; ?>rsdsale"><i class="fa fa-list "></i> <span><?= $this->lang->line('rsd_Purchases'); ?></span></a></li>
         <?php //} ?>
        
         <?php //if($CI->permissions('rsderrorcode')) { ?>
         <li class="customers-view-active-li"><a href="<?php echo $base_url; ?>rsderrorcode"><i class="fa fa-list "></i> <span><?= $this->lang->line('rsd_error_code'); ?></span></a></li>
         <?php //} ?>

         <?php //if($CI->permissions('rsdsalescancel')) { ?>
        <li class="suppliers-active-li"><a href="<?php echo $base_url; ?>rsdsalescancel"><i class="fa fa-plus-square-o "></i> <span><?= $this->lang->line('rsd_sale_cancel'); ?></span></a></li>
        <?php //} ?>
       

        <?php //if($CI->permissions('rsdsaleservice')) { ?>
         <li class="customers-view-active-li"><a href="<?php echo $base_url; ?>rsdsaleservice"><i class="fa fa-list "></i> <span><?= $this->lang->line('rsd_sale'); ?></span></a></li>
         <?php //} ?>

         <?php if($CI->permissions('suppliers_view')) { ?>
              <!-- <li class="suppliers-list-active-li"><a href="<?php //echo $base_url; ?>suppliers"><i class="fa fa-list "></i> <span><?//= $this->lang->line('rsd_Sales_returns'); ?></span></a></li> -->
              <?php } ?>

         <?php if($CI->permissions('import_customers')) { ?>
         <!-- <li class="import_customers-active-li"><a href="<?php //echo $base_url; ?>import/customers"><i class="fa fa-arrow-circle-o-left "></i> <span><?//= $this->lang->line('rsd_Purchases_return'); ?></span>
              </a></li> -->
         <?php } ?>

          <?php if($CI->permissions('import_suppliers')) { ?>
               <li class="import_suppliers-active-li"><a href="webrun:D:\Esraa\RSD\PharmaSoft_RSD.exe"> <i class="fa fa-arrow-circle-o-left "></i> <span><?= $this->lang->line('rsd_connect'); ?></span>
              </a></li>
               <?php } ?>
  <?php if($CI->permissions('import_suppliers')) { ?>
               <li class="import_suppliers-active-li"><a href="https://www.freecodecamp.org/" target="_blank" rel="noopener noreferrer"><i class="fa fa-arrow-circle-o-left "></i> <span><?= $this->lang->line('rsd_web'); ?></span>
              </a></li>
               <?php } ?>
          </ul>
        </li>    
