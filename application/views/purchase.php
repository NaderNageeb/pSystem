...
<script>
    ...
    function show_purchase_item_modal(row_id){
      ...
      var item_expire_date =  $("#item_expire_date_"+row_id).val();
      var item_price =   $("#item_price_"+row_id).val();
      ...
      $("#popup_item_expire_date").val(item_expire_date);
      $("#popup_item_price").val(item_price);
     ...
     function set_info(){
      ...
      var item_expire_date = $("#popup_item_expire_date").val();
       var item_price = $("#popup_item_price").val();
      ...
      $("#item_expire_date_"+row_id).val(item_expire_date);
      $("#item_price_"+row_id).val(item_price);
