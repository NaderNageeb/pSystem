 ...
 <?php include"sidebar.php"; ?>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
         <h1>
            <?=$page_title;?>
            <small>print/prescription</small>
         </h1>
         <ol class="breadcrumb">
               ...
               <div class="row">
                  ...
                  <div class="col-md-12">
                        ...
                        <?= form_open('#', array('class' => 'form-horizontal', 'id' => 'labels-form', 'enctype'=>'multipart/form-data', 'method'=>'POST'));?>
                           ...
                           <div class="row">
                              ...
                              <div class="col-md-12">
                                <!-- Store Code -->
                                <?php $store_id=''; ?>
                                <?php /* $this->load->view('store/store_code',array('show_store_select_box'=>true,'store_id'=>$store_id,'label_length'=>'col-sm-2','div_length'=>'col-sm-4')); }else{*/
                              ...
                              /*}*/ ?>
                                ...
                                <label for="warehouse" class="col-sm-2 control-label">
                              <?php  echo $this->lang->line('warehouse');?>
                              <span class="text-danger">*</span> </label>
                              <div class="col-sm-3">
                              <select class="form-control select2" id="warehouse_id" title="Select Warehouse" name="warehouse_id"  style="width: 100%;">
                             <?php
                             $this->db->select("*")->where("status",1)->from("db_warehouse");
                             $q2=$this->db->get();
                             if($q2->num_rows()>0)
                             {
		            ...
		            ?>
                              ...
                              <?php     
                              //  $this->load->view('warehouse/warehouse_code',array('show_warehouse_select_box'=>true,'warehouse_id'=>
                              //   get_store_warehouse_id(),'label_length'=>'col-sm-2','div_length'=>'col-sm-3'));
                              ...
                              <!-- Warehouse Code end -->
                                            ...
                                            <div class="col-md-8 col-md-offset-2 d-flex justify-content" >
                                              <div class="input-group">
                                                <span class="input-group-addon" title="Select Items"><i class="fa fa-barcode"></i></span>
                                                 <input type="text" class="form-control " placeholder="Item name/QrCode/Itemcode" id="item_search">
                                              </div>
                                            </div>
                                            <br>
                                            <br>
                                          ...
                                          <table class="table table-hover table-bordered col-md-8 col-md-offset-2 d-flex justify-content" style="width:67%" id="sales_table">
                                             <thead class="custom_thead">
                                                <tr class="bg-primary" >
                                                   ...
                                                   <th rowspan='2' style="width:45%"><?= $this->lang->line('prescription'); ?></th>
                                          ...
                                          <div class="col-md-6">
                                              <div class="row">
                                                  <div class="col-md-12">
                                                     <div class="form-group">
                                                <!--        <label for="" class="col-sm-4 control-label"><?//= $this->lang->line('pres'); ?></label>    
                                                        <div class="col-sm-4">
...
<!-- ./wrapper -->
      ...
      <script src="<?php echo $theme_link; ?>js/prescription.js"></script>  
      <script>
      ...
      <script type="text/javascript">
        jQuery(document).ready(function($) {
          ...
          if(isset($purchase_id)){ ?>
              ...
              var base_url=$("#base_url").val();
              var rowcount=$("#hidden_rowcount").val();
              $.post(base_url+"prescription/show_labels/"+<?=$purchase_id;?>,{},function(result){
